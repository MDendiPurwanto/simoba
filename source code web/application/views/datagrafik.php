<?php
$this->db->select('banjir, date');

$dataSensorBanjir = $this->db->get("tb_sensor")->result();
foreach ($dataSensorBanjir as $k => $v) {
  $arrBanjir[]=['label'=>$v->date,'y'=>$v->banjir];

}
//  print_r(json_encode($arrBanjir,JSON_NUMERIC_CHECK));die();
?>
<!DOCTYPE html>
<html lang="en">
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	data: [
	{
		...
		type: "area",
		dataPoints: 
      <?=json_encode($arrBanjir,JSON_NUMERIC_CHECK);?>
    ...
    <div id="layoutSidenav_content">
      <main>
        <div class="container-fluid px-4">
          <!-- konten-->
          <h1 class="mt-4">Halaman Monitoring Grafik</h1>
          ...
          <h6 style="color:red">Data Tidak Boleh Kosong</h6>
