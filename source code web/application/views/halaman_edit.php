    ...
    <div id="layoutSidenav_content">
      <main>
        <div class="container-fluid px-4">
          <!-- konten-->
          <h1 class="mt-4">Halaman Update User</h1>
          <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active">Data User Update</li>
          </ol>
          <form action="<?php echo base_url('Datauser/fungsiEdit') ?>" method="post">
            <div class="form-group">
              <label for="id">ID User</label>
              <input type="text" class="form-control" id="id" name="id" readonly value="<?php echo $queryUserEdit->id ?>">
            </div>
            <div class="form-group">
              <label for="nama">Nama User</label>
              <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $queryUserEdit->nama ?>">
            </div>
            <div class="form-group">
              <label for="password">Password</label>
              <input type="text" class="form-control" id="password" name="password" value="<?php echo $queryUserEdit->password ?>">
            </div>
            <br>
            <div class="form-group">
              <label for="status">Status</label>
              <input type="Number" class="form-control" id="status" name="status" readonly value="<?php echo $queryUserEdit->status ?>">
            </div>
            <br>
            <button type="submit" class="btn btn-primary" value="tambah">Update User</button>
          </form>
          <div class="row">
          </div>
        </div>
